...
G4VPhysicalVolume *MyDetectorConstruction::Construct()
{
	...
	physAir1 = new G4PVPlacement(0,G4ThreeVector(0.,0.,-1.336*m),logicAir1,"physAir1",logicWorld,false,0,true);


	// Interaction Chamber
	solidRadiator = new G4Box("solidRadiator",1*m,1*m,0.336*m);
	...
	physAir2 = new G4PVPlacement(0,G4ThreeVector(0.,0.,+1.336*m),logicAir2,"physAir2",logicWorld,false,0,true);
...
void MyDetectorConstruction::ConstructSDandField(){
       ...
       //logicAir2->SetSensitiveDetector(sensDet);
       logicRadiator->SetSensitiveDetector(sensDet2);
